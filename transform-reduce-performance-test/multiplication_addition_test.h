...
namespace {
	...
	/*******************************************************************************/
	/*                   multiplication-trasform/addition-reduce                   */
	/*******************************************************************************/
	template<typename T>
	auto multiplication_addition_test(
		...
		if constexpr (std::is_arithmetic_v<T>) {
			...
			auto test_2_3_4_5_6_7_8_results{ transform_reduce_test<T, std::multiplies, std::plus>(nIter, szData) };
